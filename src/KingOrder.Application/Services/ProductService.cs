using AutoMapper;
using KingOrder.Application.Comparers;
using KingOrder.Application.Shared.Exceptions;
using KingOrder.Application.Filters;
using KingOrder.Application.Services.Interfaces;
...
namespace KingOrder.Application.Services
{
    public class ProductService : BaseService, IProductService
    {
        ...
        public async Task<ProductResponseViewModel> GetByGuid(Guid guid)
        {
            ...
            if (productDb == null)
                throw new KingOrderException("Product not found!");
        ...
        public async Task<ProductResponseViewModel> Create(ProductRequestViewModel productViewModel)
        {
            ...
            if (existentProduct != null)
                throw new KingOrderException("Product with same Gtin already registered!");
        ...
        public async Task<ProductResponseViewModel> Update(Guid guid, ProductRequestViewModel productViewModel)
        {
            ...
            if (existentProduct != null)
                throw new KingOrderException("Another product with same Gtin already registered!");
